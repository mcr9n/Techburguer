...
public class FazerPedido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelValorTotal.setForeground(new java.awt.Color(187, 187, 187));
    ...
    private void checkBoxPedidoDeAniversarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkBoxPedidoDeAniversarioActionPerformed
		pedidoDeAniversario = !pedidoDeAniversario;
	...
	private void atualizaTabelaCarrinho(ArrayList<Produto> carrinho) {
		...
		for (Produto produto : carrinho) {
			if (nomeProdutoAnterior.equals(produto.getNome())) {
				tableModel.setValueAt(contarOcorrencias(carrinho, produto), tableModel.getRowCount() - 1, 2);
			} else {
	...
	private void atualizaPreco(ArrayList<Produto> carrinho) {
		...
		labelValorTotal.setText(Float.toString(valor));
	}
